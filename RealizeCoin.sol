...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x59FCF4f5171F5D98a2be5f66cc41947575ac7903;
...
contract REALIZE is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x72ddb672166A216cE07138864FB0A8704914B25D;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 999 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Realize Verse Network";
    string private _symbol = "REALIZE";
    ...
    uint256 private numTokensSellToAddToLiquidity = 4995 * 10**5 * 10**9;
